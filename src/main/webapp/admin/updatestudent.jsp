    ...
    <div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="admin/editstudent" id="editfrom" method="post" onsubmit="return validate()">
					<input type="hidden" name="id" value="${update[0].id}">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">学号</label>
							<div class="col-sm-5">
								<input type="number" class="form-control" id="studentId" name="studentid" placeholder="请输入学号" value="${update[0].studentid}" onblur="idValidate()" readonly="readonly">
								<input type="hidden" id="oldStudentId" value="${update[0].studentid}">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="name" name="name" placeholder="请输入学生名称"  value="${update[0].name}" onblur="nameValidate()">
							</div>
							<span id="nameV"></span>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							    ...
							    <div class="col-sm-5">
								    <input type="date" value="<fmt:formatDate value="${update[0].enrollment}" dateStyle="medium" pattern="yyyy-MM-dd" />" id="enrollment" name="enrollment" onblur="enrollmentValidate()"/>
							    </div>
	...
	<script type="text/javascript">
		...
		function idValidate(){
			if(isNullValidate("studentId")){
				var old = document.getElementById("oldStudentId").value ;
				var newStudentId = document.getElementById("studentId").value ;
				if(old != newStudentId){
