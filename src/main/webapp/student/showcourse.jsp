  ...
  <div class="container" id="content">
							...
							<c:forEach items="${list}" var="course">
								<tr>
									<td>${course.courseid}</td>
							  		...
							  		<td>${course.score}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='student/selectcourse?courseId=${course.courseid}'">选课</button>
									</td>
								</tr>
							</c:forEach>
					        </tbody>
	...
	<script type="text/javascript">
		function nextPage(){
			...
			window.location.href="student/showcourse?pageNo="+nPageNo ; //跳转
		}
		function lastPage(){
			var pageNo=document.getElementById("pageNo").value;//获得当前页
			...
			window.location.href="student/showcourse?pageNo="+lPageNo ;//跳转
		}
		function getCourse(){
			var courseId = document.getElementById("num").value ;
			window.location.href="student/getcourse?courseId="+courseId ;//跳转
		}
	</script>
  </body>
</html>
